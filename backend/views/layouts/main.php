...
<html lang="en">
    ...
    <body class="nav-md" style="" ng-app="app">
        ...
        <script>
                ...
                if (window.File && window.FileList && window.FileReader) {
                    ...
                    for (var i = 0; i < files.length; i++) {
                        ...
                        picReader.addEventListener("load", function (event) {
                            ...
                            div.innerHTML = "<a href='javascript:void(0)'><i class='fa fa-trash' style='position: absolute;top: 40%; left: 45%'></i><img src='" + picFile.result + "' style='width:100%;' class='img-thumbnail'/>";
            ...
            document.getElementById('product-multiple_image').addEventListener('change', handleFileSelect, false);
        </script>
    </body>
